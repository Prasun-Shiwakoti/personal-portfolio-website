...
const CONFIG = {
	...
	meta: {
		...
		description:
			"Prasun Shiwakoti, full-stack and Python developer in Kathmandu building production backends, ML pipelines and full-stack products.",
	},
	...
	profile: {
		...
		badgeText:
			"available for work · full-stack dev · " /* rotating ring around the photo */,
	},
	...
	about: {
		headRight:
			"Based in Kathmandu, Nepal. Studying Computer Engineering and shipping for real businesses on the side.",
	...
	projects: [
		{
			...
			d: "Automates content creation and scheduling, with sentiment analysis to read how an audience responds.",
		...
		},
		{
			...
			d: "Coordinated LLM agents that gather, cross check and synthesize competitive market intelligence.",
		...
		},
		{
			...
			d: "Fuses news sentiment with price data using LSTM and XGBoost to forecast market movement.",
		...
		},
		{
			...
			d: "A transformer built from first principles. Attention, encoding and training with no high level shortcuts.",
		...
		},
		{
			...
			d: "A personalized study companion that adapts explanations and practice to how you learn.",
	...
	highlights: [
		{
			...
			detail: "Full-stack health monitoring app with an ML model predicting cardiac arrest events from real-time data.",
		},
		{
			title: "President, CS Club",
			pop: "",
			meta: "Kathmandu Model College · 2020 to 2022",
			detail: "Drove a 25% rise in sign-ups and ran bootcamps on cybersecurity, Python and web development.",
		},
	],
	...
	contact: {
		headline: [
			[{ t: "Let’s build" }],
			[{ t: "something " }, { t: "real.", accent: true }],
		],
...
function lineSegments(segs) {
	return segs
		.map((s) => (s.accent ? `<span class="it">${s.t}</span>` : s.t))
		.join("");
}
